...
const WriteArticle = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post("/api/ai/ai-write", {
                prompt,
        ...
        >
            ...
            >
                ...
                <input onChange={(e) => setInput(e.target.value)} value={input}
                    type='text' className='w-full p-2 px-3 mt-2 outline-none
            ...
            <div className='w-full max-w-lg p-4 bg-white rounded-lg flex
                flex-col border border-gray-200 min-h-96 max-h-[600px] overflow-y-auto'
            >
                <div className='flex items-center gap-3'>
